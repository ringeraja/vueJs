<template>
  <form @submit.prevent="submitForm">
    ...
    <div class="form-control">
      ...
      <div>
        <input id="interest-nothing" value="nothing" name="interest" type="checkbox" v-model="interest"/>
    ...
    <div class="form-control">
      <input id="confirm-terms" value="confirmTerms" name="confirm-terms" type="checkbox" v-model="confirm"/>
...
export default {
  ...
  methods: {
    submitForm(){
      ...
      console.log(this.$refs.ageInput.value + 2);
      console.log(31);
      this.userAge = null;
